...
class FashionShopGUI:
    ...
    def main_menu(self):
        ...
        titleLabel = Label(root,text="Aishat Fashion Shop")
        ...
        space_y=Label(root, text=" ")
        space_y.grid(row=4, column=1)
        space_x=Label(root, text=" ")
        space_x.grid(row=5, column=1)
        developer=Label(root, text="Jamiu Mustorpha\nDeveloper and Administrator")
        developer.grid(sticky=S+E, padx=7, pady=7, row=6, column=1)
